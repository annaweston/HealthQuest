(function($) {
    ...
    function _creds() {
        ...
        if ("NM5AvT58phnsTjnKwOmdRgKgK3ndfociFAMncCBq" && "lGu5IM5PduzO6PwlguFu2EBrTspxKFSDllwTUtno") {
            return true;
        }
    ...
    function _http(method, uri, data) {
        ...
        req = {
            ...
            headers: {
                "X-Parse-Application-Id": "NM5AvT58phnsTjnKwOmdRgKgK3ndfociFAMncCBq",
                "X-Parse-REST-API-Key": "lGu5IM5PduzO6PwlguFu2EBrTspxKFSDllwTUtno"
            }
        };
